...
const Modal:React.FC<ModalProp> = ({isOpen,onClose,onSubmit,title,body,footer,actionLabel,disabled,secondaryAction,secondaryActionLabel})=>{
        ...
        <>
            ...
            ">
                ...
                ">
                    ...
                    `}>
                        <div className="translate h-full lg:h-auto border-0 rounded-lg shadow-lg
